...
public class UnsignedDate extends PDataType<Date> {

  public static final UnsignedDate INSTANCE = new UnsignedDate();

  private UnsignedDate() {
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return equalsAny(targetType, this, UnsignedTime.INSTANCE, UnsignedTimestamp.INSTANCE)
  ...
  public boolean isBytesComparableWith(PDataType otherType) {
    return super.isBytesComparableWith(otherType) || otherType.equals(UnsignedTime.INSTANCE);
  }
  ...
  public void coerceBytes(ImmutableBytesWritable ptr, Object object, PDataType actualType,
    ...
    if (ptr.getLength() > 0 && actualType == UnsignedTimestamp.INSTANCE
  ...
  public Object getSampleValue(Integer maxLength, Integer arrayLength) {
    return new Date((Long) UnsignedLong.INSTANCE.getSampleValue(maxLength, arrayLength));
  }

  static class UnsignedDateCodec extends UnsignedLong.UnsignedLongCodec {
