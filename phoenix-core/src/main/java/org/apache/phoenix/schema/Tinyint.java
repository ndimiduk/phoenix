...
public class Tinyint extends PDataType<Byte> {
  ...
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    if (value != null) {
      if (equalsAny(targetType, this, UnsignedDouble.INSTANCE, UnsignedFloat.INSTANCE,
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return this.equals(targetType) || Smallint.INSTANCE.isCoercibleTo(targetType);
  }
