...
public class UnsignedTimestamp extends PDataType<java.sql.Timestamp> {

  public static final UnsignedTimestamp INSTANCE = new UnsignedTimestamp();

  private UnsignedTimestamp() {
  ...
  public int toBytes(Object object, byte[] bytes, int offset) {
    ...
    UnsignedDate.INSTANCE.getCodec().encodeLong(value.getTime(), bytes, offset);
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return targetType.equals(this) || UnsignedDate.INSTANCE.isCoercibleTo(targetType);
  }
  ...
  public long getMillis(ImmutableBytesWritable ptr, SortOrder sortOrder) {
    long millis =
        UnsignedLong.INSTANCE.getCodec().decodeLong(ptr.get(), ptr.getOffset(), sortOrder);
    return millis;
  }
