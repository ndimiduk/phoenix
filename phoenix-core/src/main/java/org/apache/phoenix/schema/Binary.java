...
public class Binary extends PDataType<byte[]> {
  ...
  public byte[] toBytes(Object object) { // Delegate to VARBINARY
    ...
    return Varbinary.INSTANCE.toBytes(object);
  }
  ...
  public int toBytes(Object object, byte[] bytes, int offset) {
    ...
    return Varbinary.INSTANCE.toBytes(object, bytes, offset);
  ...
  public Object toObject(byte[] bytes, int offset, int length, PDataType actualType,
    ...
    return Varbinary.INSTANCE.toObject(bytes, offset, length, actualType, sortOrder);
  }
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return equalsAny(targetType, this, Varbinary.INSTANCE);
  }
  ...
  public boolean isSizeCompatible(ImmutableBytesWritable ptr, Object value, PDataType srcType,
    ...
    if (ptr.getLength() != 0 && (
        (srcType.equals(Varbinary.INSTANCE) && ((String) value).length() != ptr.getLength()) ||
  ...
  public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
    ...
    if (equalsAny(rhsType, Varbinary.INSTANCE, Binary.INSTANCE)) {
  ...
  public String toStringLiteral(byte[] b, int offset, int length, Format formatter) {
    ...
    return Varbinary.INSTANCE.toStringLiteral(b, offset, length, formatter);
  }

  @Override
  public Object getSampleValue(Integer maxLength, Integer arrayLength) {
    return Varbinary.INSTANCE.getSampleValue(maxLength, arrayLength);
  }
}
