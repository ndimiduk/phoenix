...
public class PDouble extends PDataType<Double> {
  ...
  public Object toObject(Object object, PDataType actualType) {
    ...
    double de;
    if (equalsAny(actualType, PDouble.INSTANCE, UnsignedDouble.INSTANCE)) {
      return object;
      ...
      de = (Long) object;
      return de;
    } else if (equalsAny(actualType, PInteger.INSTANCE, UnsignedInt.INSTANCE)) {
      de = (Integer) object;
      return de;
  ...
  public Double toObject(byte[] b, int o, int l, PDataType actualType,
    ...
    if (equalsAny(actualType, PDouble.INSTANCE, UnsignedDouble.INSTANCE, PFloat.INSTANCE,
        UnsignedFloat.INSTANCE, PLong.INSTANCE, UnsignedLong.INSTANCE, PInteger.INSTANCE,
  ...
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    if (value != null) {
      ...
      if (targetType.equals(UnsignedDouble.INSTANCE)) {
        return d >= 0;
      ...
      } else if (targetType.equals(UnsignedLong.INSTANCE)) {
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return equalsAny(targetType, this, Decimal.INSTANCE, Varbinary.INSTANCE, Binary.INSTANCE);
  }
