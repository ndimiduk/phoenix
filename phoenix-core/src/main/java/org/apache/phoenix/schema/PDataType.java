...
public abstract class PDataType<T> implements DataType<T>, Comparable<PDataType<?>> {
  ...
  public boolean isBytesComparableWith(PDataType otherType) {
    return this == otherType
        || this.getClass() == Varbinary.class
        || otherType == Varbinary.INSTANCE
        || this.getClass() == Binary.class
        || otherType == Binary.INSTANCE;
  }
  ...
  public static boolean isDoubleOrFloat(PDataType type) {
    return type == PFloat.INSTANCE
        ...
        || type == UnsignedFloat.INSTANCE || type == UnsignedDouble.INSTANCE;
  }
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return this.equals(targetType) || targetType.equals(Varbinary.INSTANCE);
  }
