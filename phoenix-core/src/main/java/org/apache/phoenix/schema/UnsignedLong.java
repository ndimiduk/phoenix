 ...
 */
public class UnsignedLong extends PDataType<Long> {
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return targetType == this || targetType == UnsignedDouble.INSTANCE || PLong.INSTANCE
  ...
  public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
    ...
    } else if (equalsAny(rhsType, PDouble.INSTANCE, PFloat.INSTANCE, UnsignedDouble.INSTANCE,
        UnsignedFloat.INSTANCE)) {
