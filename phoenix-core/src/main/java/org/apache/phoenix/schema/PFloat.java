...
public class PFloat extends PDataType<Float> {
  ...
  public Object toObject(Object object, PDataType actualType) {
    ...
    float f;
    if (equalsAny(actualType, PFloat.INSTANCE, UnsignedFloat.INSTANCE)) {
      return object;
  ...
  public Float toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder,
    ...
    if (equalsAny(actualType, PFloat.INSTANCE, UnsignedFloat.INSTANCE, PDouble.INSTANCE,
        UnsignedDouble.INSTANCE, PLong.INSTANCE, UnsignedLong.INSTANCE, PInteger.INSTANCE,
  ...
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    if (value != null) {
      float f = (Float) value;
      if (targetType.equals(UnsignedFloat.INSTANCE)) {
        return f >= 0;
