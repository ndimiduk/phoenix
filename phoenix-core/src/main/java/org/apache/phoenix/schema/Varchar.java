...
public class Varchar extends PDataType<String> {
  ...
  public Object toObject(Object object, PDataType actualType) {
    if (equalsAny(actualType, this, Char.INSTANCE)) {
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return equalsAny(targetType, this, Char.INSTANCE, Varbinary.INSTANCE, Binary.INSTANCE);
  }

  @Override
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    if (isCoercibleTo(targetType)) {
      if (targetType.equals(Char.INSTANCE)) {
        return value != null;
      }
      return true;
    }
  ...
  public boolean isBytesComparableWith(PDataType otherType) {
    return super.isBytesComparableWith(otherType) || otherType == Char.INSTANCE;
  }
