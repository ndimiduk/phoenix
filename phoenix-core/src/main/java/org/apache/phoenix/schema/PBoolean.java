...
public class PBoolean extends PDataType<Boolean> {
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return super.isCoercibleTo(targetType) || targetType.equals(Binary.INSTANCE);
  }

  @Override
  public boolean isCastableTo(PDataType targetType) {
    // Allow cast to BOOLEAN so it can be used in an index or group by
    return super.isCastableTo(targetType) || targetType.equals(Decimal.INSTANCE);
  }
  ...
  public Object toObject(Object object, PDataType actualType) {
    ...
    if (actualType == Varbinary.INSTANCE || actualType == Binary.INSTANCE) {
