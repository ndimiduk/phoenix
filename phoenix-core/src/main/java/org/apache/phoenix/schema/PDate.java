...
public class PDate extends PDataType<Date> {
  ...
  public Object toObject(Object object, PDataType actualType) {
    ...
    if (equalsAny(actualType, PTime.INSTANCE, UnsignedTime.INSTANCE)) {
    ...
    } else if (equalsAny(actualType, PDate.INSTANCE, UnsignedDate.INSTANCE)) {
      return object;
  ...
  public Date toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength, Integer scale) {
    ...
    if (equalsAny(actualType, PTimestamp.INSTANCE, UnsignedTimestamp.INSTANCE, PDate.INSTANCE,
        UnsignedDate.INSTANCE, PTime.INSTANCE, UnsignedTime.INSTANCE, PLong.INSTANCE,
  ...
  public boolean isCastableTo(PDataType targetType) {
    return super.isCastableTo(targetType) || equalsAny(targetType, Decimal.INSTANCE, PLong.INSTANCE, UnsignedLong.INSTANCE);
  }

  @Override
  public boolean isCoercibleTo(PDataType targetType) {
    return equalsAny(targetType, PDate.INSTANCE, PTime.INSTANCE, PTimestamp.INSTANCE, Varbinary.INSTANCE, Binary.INSTANCE);
  }

  @Override
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    if (value != null) {
      if (equalsAny(targetType, UnsignedTimestamp.INSTANCE, UnsignedDate.INSTANCE,
  ...
  public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
    if (rhsType == PTimestamp.INSTANCE || rhsType == UnsignedTimestamp.INSTANCE) {
