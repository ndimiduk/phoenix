...
public class UnsignedTinyint extends PDataType<Byte> {

  public static final UnsignedTinyint INSTANCE = new UnsignedTinyint();
  ...
  public Object toObject(Object object, PDataType actualType) {
    Byte v = (Byte) Tinyint.INSTANCE.toObject(object, actualType);
  ...
  public Object toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder,
    ...
    Byte v = (Byte) Tinyint.INSTANCE.toObject(b, o, l, actualType, sortOrder);
    throwIfNonNegativeNumber(v);
    return v;
  }
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return targetType.equals(this) || UnsignedSmallint.INSTANCE.isCoercibleTo(targetType)
        || Tinyint.INSTANCE.isCoercibleTo(targetType);
  }

  @Override
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    return super.isCoercibleTo(targetType, value) || Tinyint.INSTANCE
  ...
  public int getResultSetSqlType() {
    return Tinyint.INSTANCE.getResultSetSqlType();
  }
  ...
  static class UnsignedByteCodec extends Tinyint.ByteCodec {
