...
public class PInteger extends PDataType<Integer> {
  ...
  public Integer toObject(byte[] b, int o, int l, PDataType actualType,
    ...
    if (equalsAny(actualType, PLong.INSTANCE, UnsignedLong.INSTANCE, PInteger.INSTANCE,
        UnsignedInt.INSTANCE, Smallint.INSTANCE, UnsignedSmallint.INSTANCE, Tinyint.INSTANCE,
        UnsignedTinyint.INSTANCE, PFloat.INSTANCE, UnsignedFloat.INSTANCE, PDouble.INSTANCE,
        UnsignedDouble.INSTANCE)) {
  ...
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    if (value != null) {
      ...
      if (equalsAny(targetType, UnsignedDouble.INSTANCE, UnsignedFloat.INSTANCE,
          UnsignedLong.INSTANCE, UnsignedInt.INSTANCE)) {
        i = (Integer) value;
        return i >= 0;
