...
public class PLong extends PDataType<Long> {
  ...
  public Object toObject(Object object, PDataType actualType) {
    ...
    long s;
    if (equalsAny(actualType, PLong.INSTANCE, UnsignedLong.INSTANCE)) {
      return object;
    } else if (equalsAny(actualType, UnsignedInt.INSTANCE,
        PInteger.INSTANCE)) {
      s = (Integer) object;
      return s;
    } else if (equalsAny(actualType, Tinyint.INSTANCE, UnsignedTinyint.INSTANCE)) {
      s = (Byte) object;
      return s;
    } else if (equalsAny(actualType, Smallint.INSTANCE, UnsignedSmallint.INSTANCE)) {
      s = (Short) object;
      return s;
    } else if (equalsAny(actualType, PFloat.INSTANCE, UnsignedFloat.INSTANCE)) {
      ...
      s = f.longValue();
      return s;
    } else if (equalsAny(actualType, PDouble.INSTANCE, UnsignedDouble.INSTANCE)) {
      ...
      s = de.longValue();
      return s;
    } else if (actualType == Decimal.INSTANCE) {
      BigDecimal d = (BigDecimal) object;
      return d.longValueExact();
    } else if (equalsAny(actualType, PDate.INSTANCE, UnsignedDate.INSTANCE, PTime.INSTANCE,
        UnsignedTime.INSTANCE)) {
  ...
  public Long toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder,
    ...
    if (equalsAny(actualType, PLong.INSTANCE, UnsignedLong.INSTANCE,
        PInteger.INSTANCE, UnsignedInt.INSTANCE, Smallint.INSTANCE,
        UnsignedSmallint.INSTANCE, Tinyint.INSTANCE, UnsignedTinyint.INSTANCE, PFloat.INSTANCE,
        UnsignedFloat.INSTANCE, PDouble.INSTANCE, UnsignedDouble.INSTANCE, PDate.INSTANCE,
        UnsignedDate.INSTANCE, PTime.INSTANCE, UnsignedTime.INSTANCE)) {
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    ...
    return equalsAny(targetType, this, Decimal.INSTANCE, Varbinary.INSTANCE, Binary.INSTANCE, PDouble.INSTANCE);
  }

  @Override
  public boolean isComparableTo(PDataType targetType) {
    return Decimal.INSTANCE.isComparableTo(targetType);
  }
  ...
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    if (value != null) {
      long l;
      if (equalsAny(targetType, UnsignedDouble.INSTANCE, UnsignedFloat.INSTANCE,
          UnsignedLong.INSTANCE)) {
        l = (Long) value;
        return l >= 0;
      } else if (targetType.equals(UnsignedInt.INSTANCE)) {
        l = (Long) value;
        return (l >= 0 && l <= Integer.MAX_VALUE);
      } else if (targetType.equals(PInteger.INSTANCE)) {
        l = (Long) value;
        return (l >= Integer.MIN_VALUE && l <= Integer.MAX_VALUE);
      } else if (targetType.equals(UnsignedSmallint.INSTANCE)) {
        l = (Long) value;
        return (l >= 0 && l <= Short.MAX_VALUE);
      } else if (targetType.equals(Smallint.INSTANCE)) {
        l = (Long) value;
        return (l >= Short.MIN_VALUE && l <= Short.MAX_VALUE);
      } else if (targetType.equals(Tinyint.INSTANCE)) {
        l = (Long) value;
        return (l >= Byte.MIN_VALUE && l < Byte.MAX_VALUE);
      } else if (targetType.equals(UnsignedTinyint.INSTANCE)) {
        l = (Long) value;
  ...
  public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
    if (rhsType == Decimal.INSTANCE) {
      return -((BigDecimal) rhs).compareTo(BigDecimal.valueOf(((Number) lhs).longValue()));
    } else if (equalsAny(rhsType, PDouble.INSTANCE, PFloat.INSTANCE, UnsignedDouble.INSTANCE, UnsignedFloat.INSTANCE)) {
