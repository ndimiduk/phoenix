...
public class BinaryArray extends PArrayDataType<byte[][]> {

  public static final BinaryArray INSTANCE = new BinaryArray();

  private BinaryArray() {
    super("BINARY ARRAY", PDataType.ARRAY_TYPE_BASE + Binary.INSTANCE.getSqlType(),
  ...
  public byte[] toBytes(Object object, SortOrder sortOrder) {
    return toBytes(object, Binary.INSTANCE, sortOrder);
  }

  @Override
  public Object toObject(byte[] bytes, int offset, int length,
      PDataType actualType, SortOrder sortOrder, Integer maxLength, Integer scale) {
    return toObject(bytes, offset, length, Binary.INSTANCE, sortOrder, maxLength, scale,
        Binary.INSTANCE);
  }
  ...
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    ...
    for (Object i : charArr) {
      if (!super.isCoercibleTo(Binary.INSTANCE, i)) {
        return false;
      }
    }
    return true;
  ...
  public Object getSampleValue(Integer maxLength, Integer arrayLength) {
    return getSampleValue(Binary.INSTANCE, arrayLength, maxLength);
  }
}
