...
public class PTime extends PDataType<java.sql.Time> {
  ...
  public Object toObject(Object object, PDataType actualType) {
    ...
    if (equalsAny(actualType, PDate.INSTANCE, UnsignedDate.INSTANCE)) {
    ...
    } else if (equalsAny(actualType, PTime.INSTANCE, UnsignedTime.INSTANCE)) {
      return object;
