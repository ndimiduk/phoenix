...
public class Smallint extends PDataType<Short> {
  ...
  @Override
    ...
    public Short toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength, Integer scale) {
      ...
      if (equalsAny(actualType, Smallint.INSTANCE, UnsignedSmallint.INSTANCE, Tinyint.INSTANCE,
          UnsignedTinyint.INSTANCE, PLong.INSTANCE, UnsignedLong.INSTANCE, PInteger.INSTANCE,
          UnsignedInt.INSTANCE, PFloat.INSTANCE, UnsignedFloat.INSTANCE, PDouble.INSTANCE,
    ...
    public boolean isCoercibleTo(PDataType targetType, Object value) {
      if (value != null) {
        ...
        if (equalsAny(targetType, UnsignedDouble.INSTANCE, UnsignedFloat.INSTANCE,
            UnsignedLong.INSTANCE, UnsignedInt.INSTANCE, UnsignedSmallint.INSTANCE)) {
          i = (Short) value;
          return i >= 0;
        } else if (targetType == UnsignedTinyint.INSTANCE) {
          i = (Short) value;
          return (i >= 0 && i <= Byte.MAX_VALUE);
        } else if (targetType == Tinyint.INSTANCE) {
          i = (Short) value;
