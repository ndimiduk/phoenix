...
public class PTimestamp extends PDataType<java.sql.Timestamp> {
  ...
  public Object toObject(Object object, PDataType actualType) {
    ...
    if (equalsAny(actualType, PDate.INSTANCE, UnsignedDate.INSTANCE, PTime.INSTANCE,
        UnsignedTime.INSTANCE)) {
      return new java.sql.Timestamp(((java.util.Date) object).getTime());
    } else if (equalsAny(actualType, PTimestamp.INSTANCE, UnsignedTimestamp.INSTANCE)) {
      return object;
  ...
  public java.sql.Timestamp toObject(byte[] b, int o, int l, PDataType actualType,
    ...
    if (equalsAny(actualType, PTimestamp.INSTANCE, UnsignedTimestamp.INSTANCE)) {
      long millisDeserialized =
          (actualType == PTimestamp.INSTANCE ? PDate.INSTANCE : UnsignedDate.INSTANCE).getCodec()
              .decodeLong(b, o, sortOrder);
      v = new java.sql.Timestamp(millisDeserialized);
      int nanosDeserialized =
          UnsignedInt.INSTANCE.getCodec().decodeInt(b, o + Bytes.SIZEOF_LONG, sortOrder);
                /*
      ...
      return v;
        ...
        UnsignedTime.INSTANCE, PLong.INSTANCE, UnsignedLong.INSTANCE)) {
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return equalsAny(targetType, this, Varbinary.INSTANCE, Binary.INSTANCE);
  }

  @Override
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    if (value != null) {
      if (targetType.equals(UnsignedTimestamp.INSTANCE)) {
        return ((java.util.Date) value).getTime() >= 0;
      } else if (equalsAny(targetType, UnsignedDate.INSTANCE, UnsignedTime.INSTANCE)) {
        return ((java.util.Date) value).getTime() >= 0
  ...
  public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
    if (equalsAny(rhsType, PTimestamp.INSTANCE, UnsignedTimestamp.INSTANCE)) {
  ...
  public int getNanos(ImmutableBytesWritable ptr, SortOrder sortOrder) {
    int nanos = UnsignedInt.INSTANCE.getCodec()
