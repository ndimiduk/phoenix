 ...
 */
public class UnsignedInt extends PDataType<Integer> {
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return targetType.equals(this) || targetType.equals(UnsignedFloat.INSTANCE)
        || UnsignedLong.INSTANCE.isCoercibleTo(targetType)
