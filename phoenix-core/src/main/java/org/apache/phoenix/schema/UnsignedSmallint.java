...
public class UnsignedSmallint extends PDataType<Short> {

  public static final UnsignedSmallint INSTANCE = new UnsignedSmallint();
  ...
  public Object toObject(Object object, PDataType actualType) {
    Short v = (Short) Smallint.INSTANCE.toObject(object, actualType);
  ...
  public Object toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder,
    ...
    Short v = (Short) Smallint.INSTANCE.toObject(b, o, l, actualType, sortOrder);
    throwIfNonNegativeNumber(v);
    return v;
  }
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return targetType.equals(this) || UnsignedInt.INSTANCE.isCoercibleTo(targetType) || Smallint.INSTANCE
        .isCoercibleTo(targetType);
  }

  @Override
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    return super.isCoercibleTo(targetType, value) || Smallint.INSTANCE
        .isCoercibleTo(targetType, value);
  }

  @Override
  public int getResultSetSqlType() {
    return Smallint.INSTANCE.getResultSetSqlType();
  }
  ...
  static class UnsignedShortCodec extends Smallint.ShortCodec {
