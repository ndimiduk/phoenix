...
public class Varbinary extends PDataType<byte[]> {

  public static final Varbinary INSTANCE = new Varbinary();
  ...
  public boolean isCoercibleTo(PDataType targetType) {
    return equalsAny(targetType, this, Binary.INSTANCE);
  }
  ...
  public boolean isSizeCompatible(ImmutableBytesWritable ptr, Object value, PDataType srcType,
    ...
    if (ptr.getLength() != 0 && srcType.equals(Binary.INSTANCE) && maxLength != null
  ...
  public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
    ...
    if (equalsAny(rhsType, this, Binary.INSTANCE)) {
