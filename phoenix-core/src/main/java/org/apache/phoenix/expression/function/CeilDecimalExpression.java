...
/**
 *
 * Class encapsulating the CEIL operation on a {@link org.apache.phoenix.schema.Decimal}
 *
 *
 * @since 3.0.0
 */
public class CeilDecimalExpression extends RoundDecimalExpression {
    ...
    protected KeyRange getInputRangeProducing(BigDecimal result) {
        ...
        byte[] lowerRange = Decimal.INSTANCE.toBytes(stepPrevInScale(result));
        byte[] upperRange = Decimal.INSTANCE.toBytes(result);
