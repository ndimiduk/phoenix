...
//    }
    ...
    public boolean evaluate(Tuple tuple, ImmutableBytesWritable ptr) {
        ...
        if (pattern == null) { // TODO: don't allow? this is going to be slooowwww
            ...
            String value = (String) Varchar.INSTANCE.toObject(ptr, getPatternExpression().getSortOrder());
            pattern = compilePattern(value);
            if (logger.isDebugEnabled()) {
        ...
        String value = (String)Varchar.INSTANCE.toObject(ptr, getStrExpression().getSortOrder());
