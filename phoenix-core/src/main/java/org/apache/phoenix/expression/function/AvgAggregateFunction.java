...
@BuiltInFunction(name=AvgAggregateFunction.NAME, nodeClass=AvgAggregateParseNode.class, args= {@Argument(allowedTypes={Decimal.class})} )
public class AvgAggregateFunction extends CompositeAggregateFunction {
    ...
    public boolean evaluate(Tuple tuple, ImmutableBytesWritable ptr) {
        ...
        if (!countFunc.isConstantExpression()) {
            ...
            BigDecimal sum = (BigDecimal)Decimal.INSTANCE.toObject(ptr, sumFunc.getDataType());
            ...
            ptr.set(Decimal.INSTANCE.toBytes(avg));
            return true;
        }
