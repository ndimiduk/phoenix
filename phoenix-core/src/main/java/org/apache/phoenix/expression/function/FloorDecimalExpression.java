 ...
 * a column/literal of type {@link org.apache.phoenix.schema.Decimal}.
 *
 *
 * @since 3.0.0
 */
public class FloorDecimalExpression extends RoundDecimalExpression {
    ...
    protected KeyRange getInputRangeProducing(BigDecimal result) {
        ...
        byte[] lowerRange = Decimal.INSTANCE.toBytes(result);
        byte[] upperRange = Decimal.INSTANCE.toBytes(stepNextInScale(result));
