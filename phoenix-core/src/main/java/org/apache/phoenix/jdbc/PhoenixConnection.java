...
public class PhoenixConnection implements Connection, org.apache.phoenix.jdbc.Jdbc7Shim.Connection, MetaDataMutated  {
    ...
    public PhoenixConnection(ConnectionQueryServices services, String url, Properties info, PMetaData metaData) throws SQLException {
        ...
        formatters.put(UnsignedDate.INSTANCE, dateTimeFormat);
        formatters.put(UnsignedTime.INSTANCE, dateTimeFormat);
        formatters.put(UnsignedTimestamp.INSTANCE, dateTimeFormat);
        formatters.put(Decimal.INSTANCE, FunctionArgumentType.NUMERIC.getFormatter(numberPattern));
