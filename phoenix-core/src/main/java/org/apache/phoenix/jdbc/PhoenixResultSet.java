...
//        throw new SQLFeatureNotSupportedException();
    ...
    public short getShort(int columnIndex) throws SQLException {
        checkCursorState();
        Short value = (Short)rowProjector.getColumnProjector(columnIndex-1).getValue(currentRow, Smallint.INSTANCE, ptr);
        wasNull = (value == null);
        if (value == null) {
            return 0;
        }
    ...
    public URL getURL(int columnIndex) throws SQLException {
        checkCursorState();
        String value = (String)rowProjector.getColumnProjector(columnIndex-1).getValue(currentRow, Varchar.INSTANCE, ptr);
        wasNull = (value == null);
        if (value == null) {
            return null;
        }
